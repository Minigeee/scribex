...
export const biomeLegendGroups = [
  ...
  {
    title: "Low Elevation",
    biomes: ["TEMPERATE_DESERT", "GRASSLAND", "TEMPERATE_DECIDUOUS_FOREST", "TEMPERATE_RAIN_FOREST"]
  },
  {
    title: "Lowest Elevation",
    biomes: ["SUBTROPICAL_DESERT", "GRASSLAND", "TROPICAL_SEASONAL_FOREST", "TROPICAL_RAIN_FOREST"]
  },
  {
