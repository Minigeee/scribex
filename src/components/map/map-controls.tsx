...
import BiomeLegend from './biome-legend';
import StylizedLegend from './stylized-legend';
...
const MapControls = ({
  ...
  const handleBooleanChange = (key: keyof MapConfig, value: boolean) => {
    setConfig((prev) => ({ ...prev, [key]: value }));
  };
  ...
  return (
    <div className="w-full max-w-xs space-y-4">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="numPoints">Number of Points ({config.numPoints})</Label>
          <Slider
            id="numPoints"
            min={300}
            max={2500}
        ...
        <div className="space-y-2">
          ...
          <Tabs defaultValue="town" className="w-full">
            ...
            <TabsContent value="town" className="space-y-3 pt-2">
              <div className="space-y-2">
                <Label htmlFor="poiTownCount">Towns ({config.poiCounts?.town || 8})</Label>
                <Slider
                  id="poiTownCount"
                  min={0}
                  max={20}
                  ...
                  onValueChange={(value) => {
                    setConfig((prev) => ({
                      ...
                      poiCounts: {
                        ...(prev.poiCounts || {
                          town: 8, forest: 6, mountain: 4, lake: 3, castle: 2,
                          cave: 4, ruins: 5, camp: 7, oasis: 2
                        }),
                        town: value[0]
                      }
                    }));
              ...
              <div className="space-y-2">
                <Label htmlFor="poiCampCount">Camps ({config.poiCounts?.camp || 7})</Label>
                <Slider
                  id="poiCampCount"
                  min={0}
                  max={15}
              ...
              <div className="space-y-2">
                <Label htmlFor="poiCastleCount">Castles ({config.poiCounts?.castle || 2})</Label>
                <Slider
                  id="poiCastleCount"
                  min={0}
                  max={10}
            ...
            <TabsContent value="nature" className="space-y-3 pt-2">
              <div className="space-y-2">
                <Label htmlFor="poiForestCount">Forests ({config.poiCounts?.forest || 6})</Label>
                <Slider
                  id="poiForestCount"
                  min={0}
                  max={15}
              ...
              <div className="space-y-2">
                <Label htmlFor="poiMountainCount">Mountains ({config.poiCounts?.mountain || 4})</Label>
                <Slider
                  id="poiMountainCount"
                  min={0}
                  max={12}
              ...
              <div className="space-y-2">
                <Label htmlFor="poiLakeCount">Lakes ({config.poiCounts?.lake || 3})</Label>
                <Slider
                  id="poiLakeCount"
                  min={0}
                  max={10}
              ...
              <div className="space-y-2">
                <Label htmlFor="poiOasisCount">Oases ({config.poiCounts?.oasis || 2})</Label>
                <Slider
                  id="poiOasisCount"
                  min={0}
                  max={8}
            ...
            <TabsContent value="landmarks" className="space-y-3 pt-2">
              <div className="space-y-2">
                <Label htmlFor="poiCaveCount">Caves ({config.poiCounts?.cave || 4})</Label>
                <Slider
                  id="poiCaveCount"
                  min={0}
                  max={12}
              ...
              <div className="space-y-2">
                <Label htmlFor="poiRuinsCount">Ruins ({config.poiCounts?.ruins || 5})</Label>
                <Slider
                  id="poiRuinsCount"
                  min={0}
                  max={12}
        ...
        <div className="space-y-2">
          <Label htmlFor="islandFactor">Island Factor ({config.islandFactor.toFixed(2)})</Label>
          <Slider
            id="islandFactor"
            min={1}
            max={2}
            ...
            onValueChange={(value) => handleConfigChange('islandFactor', value[0])}
          />
          <p className="text-xs text-muted-foreground">
        ...
        {config.islandShape === 'complex' && (
          <>
            ...
            <div className="space-y-2">
              <Label htmlFor="noiseIntensity">Coastline Variation ({(config.noiseIntensity * 100).toFixed(0)}%)</Label>
              <Slider
                id="noiseIntensity"
                min={0}
                max={1}
                ...
                onValueChange={(value) => handleConfigChange('noiseIntensity', value[0])}
              />
              <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-2">
              <Label htmlFor="noiseScale">Noise Scale ({config.noiseScale?.toFixed(1) || '4.0'})</Label>
              <Slider
                id="noiseScale"
                min={1}
                max={8}
                ...
                onValueChange={(value) => handleConfigChange('noiseScale', value[0])}
              />
              <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-2">
              <Label htmlFor="islandCount">Peninsula Count ({config.islandCount || 3})</Label>
              <Slider
                id="islandCount"
                min={0}
                max={8}
                ...
                onValueChange={(value) => handleConfigChange('islandCount', value[0])}
              />
              <p className="text-xs text-muted-foreground">
        ...
        <div className="space-y-2">
          <Label htmlFor="relaxationIterations">Relaxation ({config.relaxationIterations})</Label>
          <Slider
            ...
            onValueChange={(value) => handleConfigChange('relaxationIterations', value[0])}
          />
          <p className="text-xs text-muted-foreground">
        ...
        <div className="space-y-2">
          ...
          <Slider
            ...
            onValueChange={(value) => handleConfigChange('riverCount', value[0])}
          />
        </div>

        <div className="space-y-2">
          <Label htmlFor="lakeProbability">Lake Frequency ({(config.lakeProbability * 100).toFixed(0)}%)</Label>
          <Slider
            id="lakeProbability"
            min={0}
            max={0.5}
            ...
            onValueChange={(value) => handleConfigChange('lakeProbability', value[0])}
          />
        </div>
      </div>
