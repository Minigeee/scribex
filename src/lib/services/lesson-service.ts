...
import type { LessonWithContent, ExerciseWithProgress, ParsedArticle } from '@/lib/types';
import { parseArticleContent } from '@/lib/utils/article-parser';

/**
 * Fetches a lesson by slug with its exercises
 */
export async function getLessonBySlug(slug: string): Promise<LessonWithContent | null> {
