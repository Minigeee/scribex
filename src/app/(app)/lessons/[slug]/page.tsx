...
import { getLessonBySlug, getLessonWithUserProgress, parseLessonArticle } from '@/lib/services/lesson-service';
      ...
      <div className="container max-w-4xl py-8 px-5 mx-auto">
        <div className="mb-8">
          ...
          {lesson.content_layer && (
            <div className="mt-4 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-primary/10 text-primary">
        ...
        <Tabs defaultValue="article" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-4 md:mb-6">
            <TabsTrigger value="article" className="flex items-center justify-center gap-1.5">
              Lesson Article
            </TabsTrigger>
            <TabsTrigger value="exercises" className="flex items-center justify-center gap-1.5">
              Exercises
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="article" className="mt-0">
            <Card>
              <CardHeader className='border-b'>
                ...
                <CardDescription>
                  Read through this article to learn about the topic before attempting the exercises.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-muted-foreground">
                  Complete these exercises to test your understanding. You need to score at least 90% to pass.
                </p>
              </div>
              
              <Card>
                <CardContent className="py-8 text-center">
                  <p className="text-muted-foreground mb-4">Sign in to track your progress and complete exercises.</p>
                  <Button asChild>
