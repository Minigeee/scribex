...
import { BrainIcon, LightbulbIcon, RefreshCwIcon, SparklesIcon } from "lucide-react";
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {[
                  {
                    title: "Mystery",
                    prompt: "A detective finds a strange object at a crime scene that doesn't belong there.",
                    color: "bg-purple-100 text-purple-800",
                  },
                  {
                    title: "Science Fiction",
                    prompt: "A student discovers they can communicate with technology in a unique way.",
                    color: "bg-blue-100 text-blue-800",
                  },
                  {
                    title: "Fantasy",
                    prompt: "A ordinary object in your home suddenly reveals magical properties.",
                    color: "bg-amber-100 text-amber-800",
                  },
                  {
                    title: "Historical",
                    prompt: "Write a letter from the perspective of someone living during an important historical event.",
                    color: "bg-green-100 text-green-800",
                  },
                  {
                    title: "Adventure",
                    prompt: "A character discovers a map hidden in an unexpected place.",
                    color: "bg-red-100 text-red-800",
                  },
                  {
                    title: "Persuasive",
                    prompt: "Argue for or against allowing students to use AI tools for writing assignments.",
                    color: "bg-indigo-100 text-indigo-800",
                  },
                ].map((item, index) => (
                  <Card key={index} className="overflow-hidden">
                    <CardHeader className="pb-2">
                      <div className={`inline-block rounded-full px-2 py-1 text-xs font-medium ${item.color}`}>
                        {item.title}
                      </div>
                    </CardHeader>
                    <CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="rounded-lg border p-4">
                <h3 className="mb-2 font-medium">Suggestions will appear here</h3>
